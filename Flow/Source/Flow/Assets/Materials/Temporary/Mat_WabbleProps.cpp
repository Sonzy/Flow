...
namespace Flow
{
	Mat_WabbleProps::Mat_WabbleProps()
	{
	...
	void Mat_WabbleProps::BindMaterial(Renderable* Parent, const VertexLayout& VertexLayout)
	{
	...
	void Mat_WabbleProps::BindMaterial(RenderableComponent* Parent, const VertexLayout& VertexLayout)
	{
		CHECK_RETURN(!Parent, "Mat_FlatColour::BindMaterial: Parent was nullptr");
